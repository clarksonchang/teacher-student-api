...
const register = (teacherEmail, studentEmailList, callback) => {
    let registerSql =
...
const commonStudents = (teacherList, callback) => {
...
const suspend = (studentEmail, callback) => {
...
const retrieveForNotifications = (teacher, notification, callback) => {
...
module.exports = { register, suspend, commonStudents, retrieveForNotifications };
